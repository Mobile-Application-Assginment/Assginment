...
public class ListDB {
    ...
    // database constants
    public static final String DB_NAME = "trip_db.db";
    ...
    public static final int    AIRPORT_ID_COL = 0;

    public static final String AIRPORT_NAME = "airport_name";
    public static final int    AIRPORT_NAME_COL = 1;
    ...
    public static final int    TIME_ID_COL = 0;

    public static final String TIME_VALUE = "time_value";
    public static final int    TIME_VALUE_COL = 1;
    ...
    public static final int    TASK_USER_ID_COL = 1;
    public static final String TASK_AIRPORT_ID = "airport_id";
    public static final int    TASK_AIRPORT_ID_COL = 2;
    public static final String TASK_TIME_ID = "time_id";
    public static final int    TASK_TIME_ID_COL = 3;


    // CREATE and DROP TABLE statements
    public static final String CREATE_AIRPORT_TABLE =
    ...
    public static final String DROP_AIRPORT_TABLE =
            "DROP TABLE IF EXISTS " + AIRPORT_TABLE;

    public static final String DROP_TIME_TABLE =
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db,
            ...
            Log.d("List DB", "Upgrading db from version "
